...
%Informal: SAT/SMT + Global optim (Taylor) + Bernstein (Zumkeller) + Gao (curse of dim) + Fluctuat + Handleman approach for positive polynomials (coarse bounds)
%Certified/Formal: SAT/SMT but not formalized yet (could be Rosa + SMTCoq) + Gappa (Flocq, coq-interval) + FPTaylor
