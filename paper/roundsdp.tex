...
Problem~\eqref{eq:maxpop}.  This problem is still intractable, so we first explain how to obtain tractable approximations of this problem. Define $g_0 := 1$. The hierarchy of SDP relaxations developed by Lasserre \cite{Lasserre01moments} provides lower bounds of $r^*$, through solving the  optimization problems $(\P_d)$:
\[
(\P_d):\left\{			
\begin{array}{rlr}
