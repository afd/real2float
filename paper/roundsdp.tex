...
Branch and bound methods with Taylor models~\cite{Berz09} are not restricted to polynomial systems and have been formalized~\cite{SolovyevH13} to solve nonlinear inequalities occurring in the proof of Kepler Conjecture. Symbolic Taylor Expansions~\cite{fptaylor15} have been implemented in the $\fptaylor$ tool to compute formal bounds of rounding errors for programs involving both polynomial and transcendental functions. This method is particularly efficient and precise to analyze various programs and it would be interesting to design a procedure combining this method with our tool on specific subsets of input constraints.
