...
\begin{tabular}{p{2.3cm}lcccccc}
\hline
\multirow{2}{*}{Benchmark} &  \multirow{2}{*}{\texttt{id}} & \multirow{2}{*}{precision} & \multirow{2}{*}{$\realtofloat$} & $\rosa$  & $\fptaylor$  &\multirow{2}{*}{IA} & \multirow{2}{*}{lower bound}
\\
...
\hline
\multirow{2}{*}{sineTaylor} & \multirow{2}{*}{\texttt{l}}
...
\hline 
\multirow{2}{*}{sineOrder3} & \multirow{2}{*}{\texttt{m}}
...
\hline
\multirow{2}{*}{sqroot} & \multirow{2}{*}{\texttt{n}}
...
\\
\hline
\multirow{1}{*}{cav10} & \texttt{v}
& (double) & ? & ? & $-$ & ? & ? \\
\multirow{1}{*}{perin} & \texttt{w}
& (double) & ? & ? & $-$ & ? & ? \\
\multirow{1}{*}{?} & \texttt{x}
& (double) & ? & ? & $-$ & ? & ? \\
%& (double) & ? & ? & ? & ? & ? \\
