...
After computing the absolute rounding error $r := \hat{f} - f$ (Line~\lineref{line:r}), one decomposes $r$ as the sum of an expression $l$ which is affine w.r.t.~the error variable $\e$ and a remainder $h$ (Line~\lineref{line:h}). One way to obtain $l$ is to compute the vector of partial derivatives of $r$ w.r.t.~$\e$ evaluated at $(\x, 0)$ and finally to take the inner product of this vector and $\e$ (Line~\lineref{line:l}). Then, the idea is to compute a precise bound of $l$ and a coarse bound of $h$. The underlying reason is that $h$ involves error term products of degree greater than 2 (e.g.~$e_1 e_2$), yielding an interval enclosure $I^h$ of a-priori much smaller width, compared to the interval enclosure $I^l$ of $l$. One obtains $I^h$ using the procedure $\iabound$ implementing basic interval arithmetic (Line~\lineref{line:iabound}). 
%
...
A preliminary step consists in computing the rounding error enclosure $I_d^p := [\underline{p_d}, \overline{p_d}]$ (Line~\lineref{line:polcnd}) for the program implementing the polynomial $p$. 
...
\label{sec:benchs}
Now, we present experimental results obtained with the implementation of the $\boundnlprog$ algorithm in the $\realtofloat$ tool.
...
\hline
\multirow{2}{*}{Benchmark (\texttt{id})} & \multirow{2}{*}{precision} & \multirow{2}{*}{$\realtofloat$} & $\rosa$  & $\fptaylor$  &\multirow{2}{*}{IA} & \multirow{2}{*}{lower bound}
\\
& & & \cite{Darulova14Popl} & \cite{fptaylor15} & & \\
\hline  
\\      
\multicolumn{7}{l}{Programs involving polynomial and semialgebraic functions}    \\
\\
\hline
%\multirow{2}{*}{Method 1} & $n^{(1)}$/$m^{(1)}$ &  $40/30$ & $212/111$ & $1039/350 $ & $4211/915$ & $130768/1991$ & $40251/3822$ \\
\multirow{1}{*}{doppler1 (\texttt{a})}
& (double) & $2.75\text{e--}13$ & $4.97\text{e--}13$ & $1.57\text{e--}13$ & $3.95\text{e+}02$ & $7.11\text{e--}14$\\
\multirow{1}{*}{doppler2 (\texttt{b})}
& (double) & $8.04\text{e--}13$ & $1.29\text{e--}12$ & $2.87\text{e--}13$ & $\nan$ & $1.14\text{e--}13$\\
\multirow{1}{*}{doppler3 (\texttt{c})}
& (double) & $1.37\text{e--}13$ & $2.03\text{e--}13$ & $8.16\text{e--}14$ & $1.09\text{e+}02$ & $4.27\text{e--}14$\\
%\multirow{1}{*}{doppler1$\star$}
%& (double) & $5.05\text{e--}05$ & $2.36\text{e--}06$ & $6.40\text{e--}07$ & $3.95\text{e+}02$ & $5.97\text{e--}07$\\
\multirow{1}{*}{rigidBody1 (\texttt{d})}
& (double) & $3.80\text{e--}13$ & $5.08\text{e--}13$ & $3.87\text{e--}13$ & $3.55\text{e--}13$ & $2.28\text{e--}13$\\
\multirow{1}{*}{rigidBody2 (\texttt{e})}
& (double) & $3.98\text{e--}11$ & $6.48\text{e--}11$ & $5.24\text{e--}11$ & $3.98\text{e--}11$ & $2.19\text{e--}11$\\
\multirow{1}{*}{verhulst (\texttt{f})}
& (double) & $3.40\text{e--}16$ & $6.82\text{e--}16$ & $3.50\text{e--}16$ & $7.86\text{e--}01$ & $2.23\text{e--}16$\\
\multirow{1}{*}{carbonGas (\texttt{g})}
& (double) & $1.10\text{e--}08$ & $1.60\text{e--}08$ & $1.25\text{e--}08$ & $3.10\text{e--}03$ & $4.11\text{e--}09$ \\
%\multirow{1}{*}{jetEngine} & (double) & ? & ? & ? & ? & ? \\
\multirow{1}{*}{predPrey (\texttt{h})}
& (double) & $1.57\text{e--}16$ & $1.98\text{e--}16$ & $1.87\text{e--}16$ & $2.02\text{e--}16$ & $1.47\text{e--}16$ \\
\multirow{1}{*}{kepler0 (\texttt{i})}
& (double) & $8.76\text{e--}14$ & $9.07\text{e--}14$ & $1.04\text{e--}13$ & $1.03\text{e--}13$ & $2.23\text{e--}14$\\
\multirow{1}{*}{kepler1 (\texttt{j})}
& (double) & $2.96\text{e--}13$ & $4.43\text{e--}13$ & $4.49\text{e--}13$ & $6.52\text{e--}13$ & $7.58\text{e--}14$\\
\multirow{1}{*}{kepler2 (\texttt{k})}
& (double) & $1.90\text{e--}12$ & $2.16\text{e--}12$ & $2.08\text{e--}12$ & $3.00\text{e--}12$ & $3.03\text{e--}13$\\
\hline
\multirow{2}{*}{sineTaylor (\texttt{l})}
& (double) & $5.53\text{e--}16$ & $9.57\text{e--}16$ & $6.71\text{e--}16$ & $9.39\text{e--}16$ & $4.45\text{e--}16$\\
& (float) & $2.97\text{e--}07$ & $1.03\text{e--}06$ & $3.51\text{e--}07$ & $5.07\text{e--}07$ & $1.79\text{e--}07$\\
\hline 
\multirow{2}{*}{sineOrder3 (\texttt{m})}
& (double) & $6.68\text{e--}16$ & $1.11\text{e--}15$ & $9.96\text{e--}16$ & $8.82\text{e--}16$ & $3.34\text{e--}16$\\
& (float) & $3.58\text{e--}07$ & $1.19\text{e--}06$ & $5.35\text{e--}07$ & $4.74\text{e--}07$ & $2.12\text{e--}07$\\
\hline
\multirow{2}{*}{sqroot (\texttt{n})}
...
\hline
\\
\multicolumn{7}{l}{Programs implementing polynomial functions with polynomial preconditions}\\
\\
\hline
\multirow{1}{*}{floudas1 (\texttt{o})}
& (double) & $2.99\text{e--}13$ & $2.99\text{e--}13$ & $3.90\text{e--}13$ & $6.36\text{e--}13$ & $1.48\text{e--}13$ \\
\multirow{1}{*}{floudas2 (\texttt{p})}
& (double) &  $9.03\text{e--}16$ & $1.12\text{e--}15$ & $9.96\text{e--}16$ & $1.12\text{e--}15$ & $2.35\text{e--}16$ \\
\multirow{1}{*}{floudas3 (\texttt{q})}
& (double) & $8.90\text{e--}15$ & $1.00\text{e--}14$ & $1.16\text{e--}14$ & $1.87\text{e--}14$ & $7.31\text{e--}15$ \\
\hline
\\
\multicolumn{7}{l}{Programs implementing transcendental functions}\\
\\
\hline
\multirow{1}{*}{logexp (\texttt{r})}
& (double) & $1.65\text{e--}15$ & $-$ & $1.71\text{e--}15$ & $8.29\text{e--}13$ & $1.19\text{e--}15$ \\
\multirow{1}{*}{sphere (\texttt{s})}
& (double) & $7.78\text{e--}15$ & $-$ & $1.29\text{e--}14$ & $7.78\text{e--}15$ & $5.05\text{e--}15$ \\
%\multirow{1}{*}{azimuth} %& (double) & ? & $-$ & $1.41\text{e--}14$ & ? & ? \\
\multirow{1}{*}{hartman3 (\texttt{t})}
& (double) & $3.85\text{e--}13$ & $-$  & $1.34\text{e--}14$ & $3.46\text{e+}05$ & $1.10\text{e--}14$ \\
\multirow{1}{*}{hartman6}
& (double) & $4.48\text{e--}13$ & $-$ & $\text{OoM}$ & $2.82\text{e+}03$ & $6.50\text{e--}14$ \\
\hline
\\
\multicolumn{7}{l}{Programs involving conditional loops}    \\
\\
\hline
\multirow{1}{*}{cav10}
& (double) & ? & ? & $-$ & ? & ? \\
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[scale=0.8]{timebound.pdf}
...
\begin{tabular}{p{2.3cm}lccc}
\hline
\multirow{1}{*}{Benchmark} & \multirow{1}{*}{$\realtofloat$} & $\rosa$  & $\fptaylor$   \\
\hline
\multirow{1}{*}{doppler1 (\texttt{a})} &
$7.73$ & $23.7$ & $7.45$\\
%\if{
...
\multirow{1}{*}{kepler2 (\texttt{k})} &
$21.6$ & $56.1$ & $939$\\
\multirow{1}{*}{sineTaylor (\texttt{l})} &
$0.42$ & $0.99$ & $9.66$ \\
\multirow{1}{*}{sineOrder3 (\texttt{m})} &
$0.16$ & $6.71$ & $5.19$\\
\multirow{1}{*}{sqroot (\texttt{n})} &
$0.38$ & $1.89$ & $10.1$\\
\multirow{1}{*}{floudas1 (\texttt{o})} &
$19.5$ & $17.8$ & $15.3$\\
\multirow{1}{*}{floudas2 (\texttt{p})} &
...
% As implemented in the $\fptaylor$ tool, we adjusted the precision $\epsilon_{f_{\R}} = 1.5 \epsilon$ for each special function $f_{\R} \in \{\sin, \cos, \log, \exp \}$.
...
% also able to handle input variable uncertainties
% Our tool is limited w.r.t. symbolic manipulations (derivation, normalization of rational functions,...) thus not able to handle azimuth. However we found that FPTaylor upper bound for the azimuth benchmark is \infty after 2240 seconds of computation.
