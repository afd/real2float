...
For each problem presented in Table~\ref{table:error}, we consider a program involving a nonlinear function $f(\x)$, involving variables $\x$ lying in a set $\X$ contained in a box $[\a, \b]$.
...
%~\cite{fptaylor15} $\rosa$ paper~\cite{Darulova14Popl}

%We associate a character to each benchmark to be able 
