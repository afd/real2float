...
Here, $|e_1|$ is bounded by the machine $\epsilon$ while $|e_2|$ (resp.~$|e_3|$) are bounded with the adjusted absolute error $\epsilon(\log)$ (resp.~$\epsilon(\exp)$).


One obtains the decomposition $r(x_1, \e) := \hat{f}(x_1,\e) - f(x_1) = l(x_1,\e) + h(x_1,\e) = s_1 (x_1) e_1 + s_2 (x_1) e_2 + s_3 (x_1) e_3 + h(x_1, \e)$, with 
$s_1(x_1) = \frac{\exp(x_1)} {1 + \exp(x_1)}$, $s_2(x_1) = 1$ and $s_3(x_1) = f(x_1)$.
